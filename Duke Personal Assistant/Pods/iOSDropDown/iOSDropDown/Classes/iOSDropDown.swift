...
open class DropDown : UITextField{
    ...
    //MARK: Closures
    fileprivate var didSelectCompletion: (String, Int ,Any) -> () = {selectedText, index , id  in }
    ...
    public func didSelect(completion: @escaping (_ selectedText: String, _ index: Int , _ id:Any ) -> ()) {
